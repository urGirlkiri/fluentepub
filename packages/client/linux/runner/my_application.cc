...
static void my_application_activate(GApplication* application) {
  ...
  const string iconFilename = "assets/branding/512x512.png";
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "Fluent Epub");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "Fluent Epub");
  }
  ...
  // for transparent.
  gdk_rgba_parse(&background_color, "#0D1821");
